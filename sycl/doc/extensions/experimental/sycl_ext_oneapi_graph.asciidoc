...
An exception to this rule is link:../experimental/sycl_ext_oneapi_reusable_events.asciidoc#graph-external-property[
`graph_external`], which defines a `graph_external` property enabling reusable
events to synchronize outside the graph.
