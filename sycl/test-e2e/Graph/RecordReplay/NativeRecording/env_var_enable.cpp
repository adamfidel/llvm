...
// recording mode. This test validates that the environment variable approach
// still works alongside the property-based approach.
...
int main() {
  ...
  // performance (no property needed)
